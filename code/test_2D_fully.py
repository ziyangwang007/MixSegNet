...
parser.add_argument('--exp', type=str,
                    default='ACDC/Mixed_supervised_f', help='experiment_name')
...
def Inference(FLAGS):
    ...
    # net = ViT_seg(config, img_size=[224, 224], num_classes=4).cuda()
    # net.load_from(config)



    save_mode_path = os.path.join(
        snapshot_path, 'unet_best_model2.pth')
